...
@RestController
@RequestMapping("/chat")
@Tag(name = "Chat Service", description = "/chat/{endpoint của chat service} để có thể truy cập API của chat. Xem đầy đủ tại: https://github.com/dainji04/LVTN-Management/blob/main/chat-service/API_TESTING.md")
